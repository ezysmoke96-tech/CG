...
def save_medals(data: dict) -> None:
    _save("medals", data)


def get_awarded_medals() -> dict:
    return _load("awarded_medals")


def save_awarded_medals(data: dict) -> None:
    _save("awarded_medals", data)


def get_strikes() -> dict:
    return _load("strikes")
